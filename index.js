...
// const uri = "mongodb+srv://<username>:<password>@cluster0.52lko5e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
    try {
        ...
        app.post('/payments', async (req, res) => {
            ...
            // send user email about confirmation
            // mg.messages
            //     .create(process.env.MAIL_SENDING_DOMAIN, {
            //         from: "Mailgun Sandbox <postmaster@sandboxdcc663251f1446928500cda2ac253cc9.mailgun.org>",
            //         to: ["forstudy1958@gmail.com"],
            ...
            //            <p>don't forget to give us your feedback</p>
            //         </div>
            //         `
            //     })
         ...
         * 2. for every menuItemIds (which is an array) find the item from menuCollection.
         * 3. for every item in the menu collection that you found from the payment entry (document).
        */
